...
const MovieDetails = ({ movie, status }) => {
  ...
  const { id, title, overview, vote_average, genres, name, poster_path, original_title, original_name }= movie;
      ...
      {status === STATUS.PENDING && <LoaderComponent />}
        ...
        <div className={styles.wrapper}>
          ...
          <div className={styles.description}>
            ...
            <h2 className={styles.movieSubTitle}>Tytuł oryginalny: <em>{original_title || original_name}</em></h2>
